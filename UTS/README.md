...
def detect_faces(our_image):
    ...
    faces = face_cascade.detectMultiScale(new_img, 1.1, 10)
...
def detect_eye(our_image):
    new_img = np.array(our_image.convert("RGB"))
    eyes = eye_cascade.detectMultiScale(new_img, 1.1, 10)
    for (x, y, w, h) in eyes:
        cv2.rectangle(new_img, (x,y), (x+w, y+h), (255, 0, 0), 2)
    return new_img, eyes
...
def main():
    ...
    if choice == 'Detection':
        ...
        st.text('Nama Saya Dafa Alfiana Erlangga NIM : 312210446 Mahasiswa Universitas Pelita Bangsa')
...
# Hasilnya
### Face Detection
<img width="956" alt="image" src="https://github.com/Angga674/UTS-UAS_PENGOLAHAN-CITRA-DIGITAL/blob/main/UTS/detect_faces.png">

### Eyes Detection
<img width="956" alt="image" src="https://github.com/Angga674/UTS-UAS_PENGOLAHAN-CITRA-DIGITAL/blob/main/UTS/detect%20eyes.png">
